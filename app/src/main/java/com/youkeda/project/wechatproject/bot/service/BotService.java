            ...
            for (WeixinMessage msg : messages) {
                for (OnMessageListener listener : listeners) {
                    try {
                        ...
                        ErrorHandler.swallow(log, "listener error for message from=" + msg.getFrom_user_id(), e);
                    }
                }
            }
        }
    ...
    public static class ContextPersister implements OnMessageListener, DisposableBean {
        ...
        public void onMessages(List<WeixinMessage> messages) {
            ...
            try {
                ...
                ErrorHandler.swallowWarn(log, "failed to persist resume context on message", e);
            }
        }
        ...
        public void destroy() {
            try {
                ...
                ErrorHandler.swallowWarn(log, "failed to persist resume context on destroy", e);
            }
        }
    }
    ...
    public static class IlinkClientLifecycle implements DisposableBean {
        ...
        public void onReady() {
            ...
            try {
                ...
                ErrorHandler.swallow(log, "iLink auto-login failed on startup", e);
            }
        }
        ...
        public void destroy() {
            if (resumeContextSaver != null) {
                try {
                    ...
                    ErrorHandler.swallow(log, "failed to export resume context", e);
                }
            }
            ilinkClient.close();
        }
