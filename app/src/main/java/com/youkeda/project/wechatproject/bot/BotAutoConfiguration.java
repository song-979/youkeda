...
public class BotAutoConfiguration {
    ...
    private ResumeContext loadResumeContext() {
        ...
        try {
            ...
            ErrorHandler.swallowWarn(log, "failed to load resume context from " + RESUME_CONTEXT_PATH, e);
            return null;
        }
    }
    ...
    private void saveResumeContext(ResumeContext resumeContext) {
        ...
        try {
            ...
            ErrorHandler.swallow(log, "failed to save resume context", e);
        }
    }
    ...
    public ImageGenClient imageGenClient(AgentProperties props) {
        String genUrl = props.getImageGenApiUrl() != null ? props.getImageGenApiUrl() : "";
        String apiUrl = props.getApiUrl() != null ? props.getApiUrl() : "";
        boolean isDashScope = genUrl.contains("dashscope") || apiUrl.contains("dashscope");
        if (isDashScope) {
            log.info("creating DashScopeImageGenClient for model={}", props.getImageGenModel());
