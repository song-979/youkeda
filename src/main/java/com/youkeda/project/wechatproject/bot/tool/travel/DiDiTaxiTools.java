package com.youkeda.project.wechatproject.bot.tool.travel;
...
public class DiDiTaxiTools implements ToolService.ProjectTool {
    ...
    // -------------------------------------------------------------------------
    // ThreadLocal user tracking — set by the router before tool execution
    // -------------------------------------------------------------------------
    ...
    /** Clear by the router in its finally block. */
