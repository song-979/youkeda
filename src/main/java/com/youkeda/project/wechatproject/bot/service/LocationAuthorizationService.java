...
public class LocationAuthorizationService {
    ...
    public ReverseGeocodeInfo reverseGeocodeInfo(double longitude, double latitude) {
        ReverseGeocodeResult result = reverseGeocode(longitude, latitude);
    ...
    public record ReverseGeocodeInfo(double longitude,
                                     double latitude,
                                     String address,
                                     String poiName,
                                     String adcode,
