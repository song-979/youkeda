...
import com.youkeda.project.wechatproject.bot.service.SQLiteConversationMemory;
...
public class BotAutoConfiguration {
    ...
    public ConversationMemory conversationMemory(AgentProperties props) {
        if ("sqlite".equalsIgnoreCase(props.getMemoryBackend())) {
            log.info("creating SQLiteConversationMemory dbPath={}, maxRounds={}, ttlMin={}",
                    props.getMemoryDbPath(), props.getMaxHistoryRounds(), props.getMemoryTtlMinutes());
            return new SQLiteConversationMemory(
                    props.getMemoryDbPath(),
